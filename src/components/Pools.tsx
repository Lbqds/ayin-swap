...
function PoolDetailsCard({
  ...
  const sharePecentage = BigNumber((poolTokenBalance * 100n).toString())
    .div(BigNumber(state.totalSupply.toString()))
    .toFixed(5);
  return (
    <Card
      variant="elevation"
    ...
    >
      ...
      >
        ...
        <DetailItem
          ...
          itemValue={
            state.totalSupply === 0n ? '0 %' : `${parseFloat(sharePecentage)} %`
          }
        />
      </div>
    </Card>
